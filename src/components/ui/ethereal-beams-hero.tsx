...
const BeamsButton = ({ variant = "default", size = "sm", className = "", children, ...props }: ButtonProps) => {
  const baseClasses =
...
// ============================================================================
// MAIN HERO COMPONENT (standalone, with embedded nav)
// ============================================================================
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            <div className="flex items-center">
              <span className="text-xl font-bold text-white">TalentWick</span>
            </div>
            ...
            <div className="hidden md:flex items-center space-x-1 rounded-full bg-white/5 backdrop-blur-xl border border-white/10 p-1 -mr-6">
              <a href="#" className="rounded-full px-4 py-2 text-sm font-medium text-white/90 transition-all hover:bg-white/10 hover:text-white">
                Home
              </a>
              <a href="/browse-jobs" className="rounded-full px-4 py-2 text-sm font-medium text-white/90 transition-all hover:bg-white/10 hover:text-white">
                Browse Jobs
              </a>
              <a href="/login" className="rounded-full px-4 py-2 text-sm font-medium text-white/90 transition-all hover:bg-white/10 hover:text-white">
                Sign In
              </a>
            </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mb-10 text-lg leading-8 text-white/80 sm:text-xl max-w-3xl mx-auto">
              Connect top talent with great companies. Smart job matching, applicant tracking, and flexible credit-based posting.
            </p>

            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
              <BeamsButton size="lg" className="shadow-2xl shadow-white/25 font-semibold">
                Browse Jobs
                <ArrowRight className="ml-2 h-5 w-5" />
              </BeamsButton>
              <BeamsButton variant="outline" size="lg" className="font-semibold bg-transparent">
                Post a Job
              </BeamsButton>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-2xl mx-auto">
              <div className="text-center">
                ...
                <div className="text-white/60 text-sm">Jobs Posted</div>
              </div>
              <div className="text-center">
